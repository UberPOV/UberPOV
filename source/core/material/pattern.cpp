...
DBL ContinuousPattern::Evaluate(const Vector3d& EPoint, const Intersection *pIsection, const Ray *pRay, TraceThreadData *pThread) const
{
    ...
    // Note - when 0.0 most of the rest doesn't matter.
    //   - Users can make pattterns faster using 0.0 for frequency as a technique today.
    //   - On a frequency of 0, using somewhat different logic below, could, for example,
    //     optionally return actual df3 index sizes, larger than 1 values, negative values. Useful?
