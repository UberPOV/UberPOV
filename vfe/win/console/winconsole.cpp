...
int main (int argc, char **argv)
{
  ...
  fprintf(stderr,
          "This is an example of a minimal console build of " BRANCH_FULL_NAME STANDALONE_VER " under Windows.\n\n"
          BRANCH_FULL_NAME STANDALONE_VER " Version " BRANCH_FULL_VERSION COMPILER_VER ".\n"
